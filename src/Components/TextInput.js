  ...
  return (
    <div className='row mb-3 input_wrapper'>
        <label htmlFor="staticEmail" className="col-sm-5 col-form-label">
                    ...
                    <input type="text" name={item['jsonKey']} disabled ={item['validate']['immutable']} pattern={item['validate']['pattern']} className="form-control" id="staticEmail" placeholder={item['placeholder']}/>
                    </div>
    </div>
  )
}
